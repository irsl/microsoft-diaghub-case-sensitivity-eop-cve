...
namespace Monitor.Core.Utilities
{
    ...
    public static class JunctionPoint
    {
        ...
        /// <param name="quickmode">If true execution focuses on replacing a junction (junctionPoint must already exist)</param>
        /// <exception cref="IOException">Thrown when the junction point could not be created or when
        /// an existing directory was found and <paramref name="overwrite" /> if false</exception>
        public static void Create(string junctionPoint, string targetDir, bool quickmode)
        {
            if (!quickmode)
            {
